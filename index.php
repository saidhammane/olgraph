...
<body>
  ...
  <!-- Pre-header Starts -->
  <div class="pre-header topBarContact">
    <div class="container">
      <div class="row">
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="h6">SOCIÉTÉ DE SERVICE INFORMATIQUE</div>
                    <h1>VOTRE PARTENAIRE IDÉAL POUR TOUS VOS BESOINS IT.</h1>
                    </div>
